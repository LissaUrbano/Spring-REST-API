...
import com.gft.algamoney.api.service.PessoaService;
...
public class PessoaResource {
	...
	@ApiOperation("Pesquisa por pessoa")
	@ApiImplicitParam(name = "Authorization", value = "Bearer Token", required = true, allowEmptyValue = false, paramType = "header", example = "Bearer access_token")
	@GetMapping("/{codigo}")
	public Pessoa buscarPessoa(@PathVariable Long codigo) {
	...
	@ApiOperation("Atualiza dados da pessoa")
	@ApiImplicitParam(name = "Authorization", value = "Bearer Token", required = true, allowEmptyValue = false, paramType = "header", example = "Bearer access_token")
	@PutMapping("/{codigo}")
	...
	@ApiOperation("Atualiza status ativo de pessoa")
	@ApiImplicitParam(name = "Authorization", value = "Bearer Token", required = true, allowEmptyValue = false, paramType = "header", example = "Bearer access_token")
